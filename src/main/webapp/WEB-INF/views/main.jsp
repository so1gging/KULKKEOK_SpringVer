                  ...
                  <c:otherwise>
                     <c:forEach var="bestStar" items="${bestStar }">
                         ...
                         <div class="col-lg-6 col-md-6 rankimg" style="max-width: 30%;">
                             <a href="beer.do?command=beerdetail&beerno=${bestStar.beer_no }"><img src="resources/img/beer/${bestStar.beer_pic }.jpg" alt=""></a>
                             <div class="hover_Text d-flex align-items-end justify-content-between">
                                 <div class="beer_align">
                                     <br>
                                     <h3><a href="beer.do?command=beerdetail&beerno=${bestStar.beer_no }">${bestStar.beer_kor_name }</a></h3>
                                     <p>${bestStar.beer_abv }%</p>
                                     ...
                                     <span>(${bestStar.count_review }개의 리뷰)</span>                             
                                 </div>
                             </div>
                         </div>
