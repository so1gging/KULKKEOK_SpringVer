                ...
                <div class="row align-items-center ">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            <a class="navbar-brand" href="main.do?command=main"> <img src="resources/img/logo.png" alt="logo" width="100px" height="100px"> </a>
                            ...
                            <div class="text-box">
    						<img src="resources/img/chat.png" style="width:60px; cursor:pointer" class="btn btn-white btn-animate click" onclick="location.href='chat.jsp'">
							</div>
                                <ul class="navbar-nav">
                                    <li class="nav-item">
